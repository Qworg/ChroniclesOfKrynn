...
/* Archetype accessors (inert MVP core).  List-based; future stacking is limited
 * by feature-replacement conflicts, not a fixed per-class slot count. */
#define GET_ARCHETYPES(ch) ((ch)->player_specials->saved.archetypes)
