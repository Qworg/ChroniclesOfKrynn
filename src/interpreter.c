...
cpp_extern const struct command_info cmd_info[] = {
    ...
    {"addmaterials", "addm", POS_DEAD, do_setmaterial, LVL_GRSTAFF, SCMD_ADDMATERIALS, TRUE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"artisanshop", "artisanshop", POS_FIGHTING, do_not_here, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"crushingblow", "crushingb", POS_FIGHTING, do_crushingblow, 1, 0, FALSE, ACTION_NONE, {0, 0}, can_crushingblow},
    ...
    {"elementalembodiment", "elementalembodiment", POS_FIGHTING, do_elementalembodiment, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, can_elementalembodiment},
    ...
    {"darkonesluck", "darkonesluck", POS_RESTING, do_dark_ones_own_luck_perk, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
    ...
    {"firesnake", "firesnake", POS_STANDING, do_firesnake, 1, 0, FALSE, ACTION_NONE, {0, 0}, can_firesnake},
...
/* {"command", "sort_as", minimum_position, *command_pointer, minimum_level, subcmd, ignore_wait, actions_required, {action_cooldowns}, *command_check_pointer},*/
    ...
    {"leap", "leap", POS_FIGHTING, do_leap, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, can_leap},
    ...
    {"perfectadaptation", "perfectadaptation", POS_FIGHTING, do_perfectadaptation_perk, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
    ...
    {"powerstrike", "powerstrike", POS_RESTING, do_powerstrike, 0, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
...
// {"read", "rea", POS_RECLINING, do_look, 0, SCMD_READ, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"ridethewind", "ridethewind", POS_FIGHTING, do_ridethewind, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, can_ridethewind},
    {"riverofhungryflame", "riverofhungryflame", POS_FIGHTING, do_riverofhungryflame, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, can_riverofhungryflame},
...
// {"resize", "resize", POS_STANDING, do_not_here, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"setmaterials", "setm", POS_DEAD, do_setmaterial, LVL_GRSTAFF, SCMD_SETMATERIALS, TRUE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"shatteringstrike", "shattering", POS_FIGHTING, do_shatteringstrike, 1, 0, FALSE, ACTION_NONE, {0, 0}, can_shatteringstrike},
    ...
    {"loadvehicle", "loadveh", POS_STANDING, do_loadvehicle, 0, 0, FALSE, ACTION_MOVE, {0, 6}, NULL},
    {"unloadvehicle", "unloadveh", POS_STANDING, do_unloadvehicle, 0, 0, FALSE, ACTION_MOVE, {0, 6}, NULL},
    ...
    {"tstatus", "tstatus", POS_RECLINING, do_transportstatus, 0, 0, TRUE, ACTION_NONE, {0, 0}, NULL},
