...
- **Detailed mechanics:**
  - **Type:** Ex.
  - **Level hooks:** 2.
  - **Rules text to implement:** At 2nd level, a swarm monger gains Vermin Heart APG as a bonus feat.
- **Implementation flags:**
...
- **Detailed mechanics:**
  - **Type:** Ex.
  - **Rules text to implement:** A swarm monger gains a +2 bonus on Knowledge (local) and Stealth checks.
- **Implementation flags:**
