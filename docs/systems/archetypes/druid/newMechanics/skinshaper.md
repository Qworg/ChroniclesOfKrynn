...
- **Detailed mechanics:**
  - **Rules text to implement:** A skinshaper adds Disguise to her list of class skills, instead of Ride.
...
- **Detailed mechanics:**
  - **Type:** Su.
  - **Level hooks:** 13.
  - **Rules text to implement:** At 13th level, a skinshaper learns to change her shape extremely quickly. She can use skinshaping as a swift action.
- **Implementation flags:**
  - ki subsystem.
