...
- **Detailed mechanics:**
  - **Type:** Su.
  - **Level hooks:** 18.
  - **Rules text to implement:** At 18th level, the penalty for the counter-summoner’s weaken summons ability changes to –4.
- **Implementation flags:**
  - summoning subsystem.
