...
- **Mechanics:**
  - Mechanics summary: A consigliere adds Knowledge (nobility) to his list of class skills, instead of Knowledge (dungeoneering).
...
- **Mechanics:**
  - Type: Ex.
  - Level hooks: 4, 8.
  - Mechanics summary: At 4th level, whenever a consigliere misses with a melee attack against an opponent, he can designate an ally within 30 feet of the target to receive a +1 insight bonus on her next attack roll against that opponent before the consigliere’s next turn. At 8th level, the insight bonus increases to +2.
- **Implementation flags:**
...
- **Mechanics:**
  - Type: Ex.
  - Level hooks: 4, 12.
  - Mechanics summary: Starting at 4th level, a consigliere can choose to gain a single teamwork feat instead of a single rogue talent. Starting at 12th level, the consigliere can choose to gain teamwork feats instead of rogue talents as many times as he chooses.
- **Implementation flags:**
  - Likely existing hooks: feat grants/restrictions, typed/untyped numeric bonus.
