...
- **Detailed mechanics:**
  - **Level hooks:** 3.
  - **Rules text to implement:** At 3rd level, a bow nomad gains Agile Maneuvers as a bonus feat.
- **Implementation flags:**
  - feat grant/prerequisite handling.
