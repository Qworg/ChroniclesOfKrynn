...
- **Mechanics:**
  - Level hooks: 2.
  - Mechanics summary: A plant speaker’s mind-affecting bard spells and class abilities also affect plants, ignoring plants’ immunity to mind-affecting effects. At 2nd level, a plant speaker’s racial plantspeech allows him to communicate with all plants, not just plants that match his alternate form.
- **Implementation flags:**
