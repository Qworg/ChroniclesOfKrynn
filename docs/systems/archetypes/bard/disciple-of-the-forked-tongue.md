...
- **Implementation flags:**
  - Likely existing hooks: numeric penalty, saving throw hook, spellcasting/spell-list hook, rage/rage-power hook, bardic performance hook.
...
- **Mechanics:**
  - Type: Su.
  - Level hooks: 2.
  - Mechanics summary: A disciple of the forked tongue can add one spell with the curse descriptor from the spell list of any spellcasting class to his list of spells known at 2nd level and every 4 levels thereafter.
- **Implementation flags:**
