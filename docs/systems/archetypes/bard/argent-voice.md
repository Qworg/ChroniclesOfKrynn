...
- **Mechanics:**
  ...
  - Mechanics summary: An argent voice gains the following bardic performances. The argent voice must use Perform (sing) with these performances. Limning Verse (Su) : At 1st level, the argent voice can sing a song that causes fiends to glow with an aura of silvery light. At 4th level and every 4 levels thereafter, the range of this ability increases by 10 feet, to a maximum of 60 feet at 20th level. Shattering Crescendo (Sp) : At 6th level, the argent voice learns to sing at frequencies capable of shattering magical effects. As a full-round action, an argent voice can use 2 rounds of bardic performance to attempt to dispel a single evil spell or enchantment spell cast by an evil creature.
