...
- **Detailed mechanics:**
  - **Rules text to implement:** An oathkeeper must be of a lawful alignment, and her alignment must be within one step of her deity’s.
...
- **Detailed mechanics:**
  - **Rules text to implement:** An oathkeeper removes Knowledge (nature) from her list of class skills and adds Appraise.
- **Implementation flags:**
  - ki subsystem.
