...
- **Mechanics:**
  - Type: Sp.
  - Level hooks: 2.
  - Mechanics summary: At 2nd level, a traceless operative’s deity helps obscure her path from others. The DC to track the traceless operative (or a group including her) increases by half her inquisitor level.
- **Implementation flags:**
