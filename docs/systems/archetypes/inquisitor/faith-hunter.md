...
- **Detailed mechanics:**
  - **Type:** Su.
  - **Level hooks:** 5.
  - **Rules text to implement:** At 5th level, a faith hunter’s bane ability functions only against creatures that are both the selected creature type and her sworn enemy alignment.
- **Implementation flags:**
  - Map replaced feature keys and verify existing engine hooks before implementation..
