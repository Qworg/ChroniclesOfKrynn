...
- **Detailed mechanics:**
  - **Type:** Su.
  - **Level hooks:** 11.
  - **Rules text to implement:** At 11th level, a drunken master is immune to fear as long as he has at least 1 point of drunken ki.
- **Implementation flags:**
...
- **Detailed mechanics:**
  ...
  - **Rules text to implement:** At 13th level, a drunken master gains DR 1/— as long as he has at least 1 point of drunken ki. At 16th level, the DR increases to 2/—. At 19th level, it increases to 3/—.
- **Implementation flags:**
  - ki subsystem.
