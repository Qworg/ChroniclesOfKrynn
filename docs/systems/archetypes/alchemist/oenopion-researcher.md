...
- **Description:** The following discoveries complement the Oenopion researcher archetype: acid bomb, bottled ooze, feral mutagen, infuse mutagen, infusion, sunlight bomb.
- **Detailed mechanics:**
  - **Rules text to implement:** The following discoveries complement the Oenopion researcher archetype: acid bomb, bottled ooze, feral mutagen, infuse mutagen, infusion, sunlight bomb.
...
- **Detailed mechanics:**
  - **Type:** Ex.
  - **Level hooks:** 3.
  - **Rules text to implement:** At 3rd level, an Oenopion researcher gains acid resistance 5.
- **Implementation flags:**
