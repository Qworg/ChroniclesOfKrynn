...
- **Detailed mechanics:**
  - **Level hooks:** 1.
  - **Rules text to implement:** At 1st level, a grenadier picks one martial weapon and becomes proficient in its use.
